...
const ProfileScreen = () => {
    ...
    return (
        <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
            ...
            <HeaderWithIcon title={' '} iconName={'settings-outline'} screenName={'settings'} />
            ...
            <View style={styles.infoContainer}>
                <View style={styles.basicInfo}>
                    ...
                    <View style={[styles.basicInfoChild, loading && styles.gap15]}>
                        ...
                        >
                            {loading ? null
                                : <Text style={[styles.username, { color: theme.colors.text }]}>{activeUser.username}</Text>
                            }
                        </Skeleton>
                        ...
                        >
                            {loading ? null
                                : <Text style={[styles.email, { color: theme.colors.text }]}>{activeUser.email}</Text>
                            }
                        </Skeleton>
                    ...
                    >
                        {loading ? null :
                            <View style={styles.buttons}>
                                <TouchableOpacity style={[styles.editButton, { backgroundColor: theme.colors.text }]}
                                    onPress={() => navigation.navigate('editprofile')}
                                >
                                    <Text style={[styles.btnText, { color: theme.colors.background }]}>Edit Profile</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={[styles.passowordButton, { borderColor: theme.colors.text }]}
                                    onPress={() => navigation.navigate('changepassword')}
                                >
                                    <Text style={[styles.btnText, { color: theme.colors.text }]}>Change Password</Text>
                                </TouchableOpacity>
                            </View>
                        }
                    </Skeleton>
            ...
            <View style={styles.storyContainer}>
                ...
                <Text style={[styles.storiesHeading, { color: theme.colors.text }]}>My Stories</Text>
