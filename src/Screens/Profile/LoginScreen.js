    ...
    return (
        <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
            ...
            <View>
                ...
                <View style={[styles.inputView, { borderColor: focus.passwordFocus ? theme.colors.secondary : theme.colors.backgroundLight }]}>
                    <MaterialCommunityIcons name={passwordIcon} size={24} color={focus.passwordFocus ? theme.colors.secondary : theme.colors.text} />
                    <TextInput
                        ref={textInputRef}
                        style={[styles.TextInput, { color: theme.colors.text }]}
                    ...
                    <Pressable onPress={() => setRevealPassword(!revealPassword)}>
                        ...
                        <MaterialCommunityIcons name={showPassword(revealPassword)} size={24} color={theme.colors.text} />
                    </Pressable>
                </View>
                <TouchableOpacity>
                    <Text style={[styles.forgot_button, { color: theme.colors.primary }]}>Forgot Password?</Text>
                </TouchableOpacity>
            </View>
