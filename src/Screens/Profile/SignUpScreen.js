...
const SignUpScreen = () => {
  ...
  const isFormDisabled = (password.length < 6 && confirmPassword < 6) && password !== confirmPassword;
    ...
    <Loader loading={loading}>
      <View
        ...
        <View>
          ...
          <View
            style={[
              styles.inputView,
              {
                borderColor: focus.username
                  ? theme.colors.secondary
                  : theme.colors.backgroundLight,
              },
            ]}>
            <MaterialCommunityIcons
              name={focus.username ? 'account' : 'account-outline'}
              size={24}
              color={
                focus.username ? theme.colors.secondary : theme.colors.text
              }
            />
            <TextInput
          ...
          <View
            ...
            <MaterialCommunityIcons
              name={focus.email ? 'email' : 'email-outline'}
              size={24}
          ...
          <View
            ...
            <Ionicons
              name={focus.password ? 'lock-open' : 'lock-open-outline'}
              size={24}
              color={
                focus.password ? theme.colors.secondary : theme.colors.text
              }
            />
            <TextInput
              style={[styles.TextInput, {color: theme.colors.text}]}
            ...
            <Pressable
              ...
              <MaterialCommunityIcons
                name={showPassword(revealPassword.password)}
                size={24}
          ...
          <View
            style={[
              styles.inputView,
              {
                borderColor: focus.confirmPassword
                  ? theme.colors.secondary
                  : theme.colors.backgroundLight,
              },
            ]}>
            <Ionicons
              name={
                focus.confirmPassword ? 'lock-closed' : 'lock-closed-outline'
              }
              size={24}
              color={
            ...
            <Pressable
              ...
              <MaterialCommunityIcons
                name={showPassword(revealPassword.confirmPassword)}
                size={24}
                color={theme.colors.text}
              />
            </Pressable>
        ...
        <View style={styles.signUpBtn}>
          <Text style={[styles.login, {color: theme.colors.text}]}>
            Have an account?
          </Text>
