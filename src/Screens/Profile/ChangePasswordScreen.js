...
const ChangePasswordScreen = () => {
    ...
    const handleSubmit = async () => {
        if (newPassword !== confirmPassword) {
            ...
            try {
                const { data } = await axios.put('/user/changePassword', { newPassword, oldPassword }, config);
                showMessage({
    ...
    const isBtnDisable = oldPassword.length < 6 || newPassword.length < 6 || confirmPassword.length < 6;
            ...
            <View style={styles.passwordContainer}>
                ...
                <View style={styles.passwords}>
                    <View style={styles.passwordBox}>
                        <Text style={[styles.passwordTitle, { color: theme.colors.text }]}>Old Password</Text>
                        <View style={[styles.passwordInput, { borderColor: borderColor() }]}>
                            ...
                            <Pressable onPress={() => setIsRevealPass1(!isRevealPass1)}>
                                ...
                                <MaterialCommunityIcons name={revealPassowrd(isRevealPass1)} size={28} color={theme.colors.text} />
                            </Pressable>
                        </View>
                    </View>
                    ...
                    {/* New Password */}
                    <View style={styles.passwordBox}>
                        <Text style={[styles.passwordTitle, { color: theme.colors.text }]}>New Password</Text>
                        <View style={[styles.passwordInput, { borderColor: borderColor() }]}>
                            ...
                            <Pressable onPress={() => setIsRevealPass2(!isRevealPass2)}>
                                ...
                                <MaterialCommunityIcons name={revealPassowrd(isRevealPass2)} size={28} color={theme.colors.text} />
                            </Pressable>
                        </View>
                    </View>
                    ...
                    <View style={styles.passwordBox}>
                        <Text style={[styles.passwordTitle, { color: theme.colors.text }]}>Confirm Password</Text>
                        <View style={[styles.passwordInput, { borderColor: borderColor() }]}>
                            ...
                            <Pressable onPress={() => setIsRevealPass3(!isRevealPass3)}>
                                ...
                                <MaterialCommunityIcons name={revealPassowrd(isRevealPass3)} size={28} color={theme.colors.text} />
                            </Pressable>
                        </View>
                    </View>
                ...
                <TouchableOpacity disabled={isBtnDisable}
                    style={[styles.Btn, { borderColor: isBtnDisable ? disabledColor : theme.colors.secondary }]}
                    onPress={handleSubmit}
                >
                    <Text style={[styles.BtnText, { color: isBtnDisable ? disabledColor : theme.colors.secondary }]}>Save Changes</Text>
                </TouchableOpacity>
            </View>
        </View>
    );
