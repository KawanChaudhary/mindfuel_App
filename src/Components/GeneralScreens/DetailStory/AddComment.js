...
const AddComment = ({ theme, handleSubmit }) => {
    ...
    return (
        <View style={[styles.addCommentContainer, { backgroundColor: theme.name === 'light' ? theme.colors.background : theme.colors.backgroundLight }]}>
            ...
            <View style={styles.addCommentContent}>
                <TextInput
                    ...
                    style={[styles.input, { backgroundColor: theme.name === 'light' ? theme.colors.background : theme.colors.backgroundLight, color: theme.colors.text }]}
                />
            </View>

            <TouchableOpacity disabled={isCommentReady} style={[styles.send, { backgroundColor: theme.colors.primary }]} onPress={submitComment}>
